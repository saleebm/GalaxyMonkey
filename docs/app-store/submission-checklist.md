...
iPhone-only app. Screenshots go in the **6.5" iPhone** slot, landscape, at
**2778 × 1284** (or 2688 × 1242) — see `build/screenshots/iphone-6.5-final/`.
...
5. **Screenshots:** drag in the 6.5" iPhone captures from
   `build/screenshots/iphone-6.5-final/` (and the App Preview video).
